...
let selector = document.querySelector('body > p:nth-child(3) > a:nth-child(4)');

console.log(selector);
console.log(selector.getAttribute('href'));
console.log(selector.getAttribute('target'));

ninjas = ['Mil&ugrave;', 'Leo', 'Chet', 'Ryu', 'Shaun'];
...
ninjas.forEach(ninja => {
  ...
  html += `<li style="color: coral">${ninja}</li>`;
});

ul.innerHTML = html;

selector = document.querySelector('.ninjas > li:nth-child(3)');
selector.innerText = `Bo`;

selector = document.querySelector('.ninjas');
const li = document.createElement('li');
li.innerText = `Claire`;
selector.appendChild(li);

selector = document.querySelectorAll('.ninjas > li');
selector.forEach(li => {
...
console.log(errors[1].classList);

errors[1].classList.remove('success');

console.log(errors[1].classList);

errors[1].classList.toggle('success');
...
const text = document.querySelector('.challenge > p');

console.log(text.innerText);
console.log(text.textContent);

const paras = document.querySelectorAll('.challenge > p');
paras.forEach(p => {
...
content.setAttribute('class', 'ending');

console.log(content.classList);

content = document.querySelector('.ending > p');
